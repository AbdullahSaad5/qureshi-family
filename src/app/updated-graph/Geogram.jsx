...
function initDiagram() {
  ...
  var nodeToolTip = $(
    go.Adornment,
    "Auto",
    $(go.Shape, "Rectangle", { fill: "whitesmoke", stroke: "black", strokeWidth: 2 }),
    $(
      go.Panel,
      "Vertical",
      { margin: 8 },
          ...
          go.Panel,
          {
            itemTemplate: $(
              ...
              $(
                ...
                { width: 15, height: 15, margin: 1, strokeWidth: 0 },
                new go.Binding("fill", "", attrFill),
                new go.Binding("geometry", "", gender === "M" ? maleGeometry : femaleGeometry)
              )
            ),
            margin: new go.Margin(0, 0, 0, 10),
            alignment: go.Spot.TopRight,
  ...
  diagram.linkTemplateMap.add(
    ...
    $(go.Link, { selectable: false }, $(go.Shape, { strokeWidth: 2.5, stroke: MARRIAGE_COLOR /* blue */ }))
  );
