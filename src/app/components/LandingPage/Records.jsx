    ...
    <section className=" flex items-center justify-around h-[400px] md:h-[520px] lg:h-[480px]">
      <div className="md:ml-6 p-6 mt-16 mb-10">
        ...
        <p className="text-md p-2">
          Embark on a journey through time with our expansive records. Uncover <br />
          the rich history of your ancestors and their legacy. With detailed <br />
          data and exclusive archives, every search reveals more. Trace your <br />
          family tree across generations and continents. Connect the dots of <br />
          your heritage with precise and reliable information. Discover the <br />
