    ...
    <div className="relative w-full h-[600px]">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20 z-10">
        ...
        <div className="grid grid-cols-12">
          <div className="flex items-center col-span-3 mt-4">
            <input
              type="text"
        ...
        {images.map((image, index) => (
          <div key={index} className="relative w-full h-[600px]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20 z-10">
              ...
              <div className="grid grid-cols-12">
                <div class="flex items-center col-span-3 mt-4">
                  <input
                    type="text"
                    placeholder="Search Member Record"
                    class="flex-grow px-4 py-4 border-none rounded-l-full focus:outline-none"
                  />
                  <button
                    type="button"
                    class="px-4 py-4 bg-[#82D026] text-white rounded-r-full  font-semibold"
                  >
                    Search
                  </button>
                </div>
