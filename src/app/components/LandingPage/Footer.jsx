...
function Footer() {
  return (
    <footer className="bg-lime-500 h-[700px]  text-white px-6 md:px-16   pt-12">
      <div className="flex flex-col md:flex-col lg:flex-row  justify-between items-center ">
        <div className="flex flex-row items-center border-b-2 border-white m- ">
          <Image
            ...
            className="mb-2 w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 xl:w-2 xl:h-20"
            style={{ width: "90px", height: "80px" }}
          />
          <h1 className="font-bold flex flex-col text-center m-4 justify-center text-3xl md:text-4xl lg:text-3xl">
            <span className="font-extrabold">Qureshi </span>
            <span className="text-black mt-4 font-extrabold text-2xl md:text-4xl lg:text-2xl">
              Family
            </span>
          </h1>
        </div>
        ...
        <div className="flex flex-row md:flex-col  lg:flex-col xl:flex-row items-center border-b-2 border-white p-6 mt-16 md:mt-8 lg:mr-8">
          <span className="font-extrabold text-3xl  md:text-3xl lg:text-xl">
            Follow Us On :
          </span>
          <div className="flex space-x-4 ml-4 mt-2 text-2xl md:text-3xl lg:text-xl ">
            <FaFacebookF />
            <FaInstagram />
            <FaTimes />
          </div>
      ...
      <div className=" flex items-center justify-center">
        <div className=" w-[90%] grid grid-cols-2 sm:grid-cols-2 sm:gap-16 md:grid-cols-2 md:gap-16 lg:grid-cols-4  lg:gap-16 xl:w-[90%] xl:grid-cols-5 px-4  border-b-2 border-white p-16">
          <div>
            <h2 className="font-extrabold mb-4 text-xl md:text-2xl lg:text-xl">
              COMPANY
            </h2>
            <div className="text-lg md:text-xl lg:text-sm font-semibold">
