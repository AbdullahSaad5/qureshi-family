  ...
  return (
    <section className="md:p-12 mb-8 mt-12 sm:mt-0">
      <div className={` text-[#82D026]  text-center m-4 p-4`}>
        <h2 className="text-5xl">Shajra-e-Nasab</h2>
      </div>

      <div className=" m-4 p- text-center">
        <p className="mt-4">
          A <span className="font-semibold text-[#646464]"> Shajra e Nasab</span> is a family
           tree that traces the lineage of a family across generations.
           It records ancestral connections,  <br />
           preserving family heritage and history. In Islamic culture, it 
           holds significance for families, especially those claiming <br /> descent 
           from notable religious or historical figures. This genealogical record 
            is often used to maintain accurate <br /> knowledge of a family’s  ancestry and is 
            sometimes referred to during important events like marriages. <br />Families may 
            pass down their Shajra e Nasab as a symbol of pride and tradition..
        </p>
      </div>
